    ...
    private fun UpdateUI(account: GoogleSignInAccount){
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener {task->
            if(task.isSuccessful) {
                com.ivanzulyan.andchallenge5.datastore.SavedPreference.setEmail(this,account.email.toString())
                com.ivanzulyan.andchallenge5.datastore.SavedPreference.setUsername(this,account.displayName.toString())
